...
class ProductsIRented extends StatefulWidget {
  const ProductsIRented({Key? key}) : super(key: key);

  @override
  State<ProductsIRented> createState() => _ProductsIRentedState();
}

class _ProductsIRentedState extends State<ProductsIRented> {
  @override
                                                    ...
                                                    PageTransition(
                                                        child: RequestDetails(
                                                            ...
                                                            image: requestCount[index]
                                                                ['productImage'],
                                                            productName: requestCount[index]['productName'],
                                                            productPrice: requestCount[index]['productPrice'],
