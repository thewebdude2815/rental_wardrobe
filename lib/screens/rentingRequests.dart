...
class RentingRequests extends StatefulWidget {
  const RentingRequests({Key? key}) : super(key: key);

  @override
  State<RentingRequests> createState() => _RentingRequestsState();
}

class _RentingRequestsState extends State<RentingRequests> {
  @override
                                                        ...
                                                        child: RequestDetails(
                                                          users: requestCount[index]
                                                            ...
                                                            productName: requestCount[index]
                                                                ['productName'],
                                                            productPrice: requestCount[index]
                                                                ['productPrice'],
